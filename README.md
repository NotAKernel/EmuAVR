...
The project was developed and built in Visual Studio for Windows, thus it is best viewed and used within their IDE. To open it, double click 'EmuAVR.slnx' in your file explorer and choose to open with Visual Studio - or open the project from within the IDE itself.
